...
public class FaceVerifyUtils {
    ...
    private static final String gateway = "iai.tencentcloudapi.com";
//    /*
//     * 计算MD5+BASE64
//     */
...
//                    + path;
//            // 2.计算 HMAC-SHA1
//            String signature = HMACSha1(stringToSign, tengxunyunResource.getSecretKey());
//            // 3.得到 authorization header
//            String authHeader = "Dataplus " + tengxunyunResource.getSecretId() + ":" + signature;
//            // 打开和URL之间的连接
...
//    }
    public String sendPostVerifyFace(int type, String face1, String face2) throws Exception {
        ...
        try {
            ...
            httpProfile.setEndpoint(gateway);
            ...
            String result = CompareFaceResponse.toJsonString(resp);
            return result;
    ...
    public boolean faceVerify(int type, String face1, String face2, double targetConfidence) {
        ...
        Object confidenceStr = map.get("Score");
